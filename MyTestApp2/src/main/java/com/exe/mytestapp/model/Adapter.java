...
////    -----------------------------------------------------
//
//    public Adapter(Context context, int resource, Player player1, Player player2, GameListener gameListener) {
...
//
////        LinearLayout layout = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.field_item_button, null);
//        ImageButton imageButton = (ImageButton) LayoutInflater.from(getContext()).inflate(R.layout.field_item_button, null);
////        ImageButton imageButton = (ImageButton) LayoutInflater.from(getContext()).inflate(R.layout.field_item_button, null);
//
...
//        imageButton.setOnClickListener(new ButtonXOClickListener(this, getContext(), x, y));
//        if(tmpPlayer == null)
//            return imageButton;
